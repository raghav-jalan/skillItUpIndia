    ...
    <section className="py-16 bg-gray-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">Our Valued Partners</h2>
        ...
        <div className="space-y-16">
          {partnerCategories.map((category) => (
            <div key={category.id} className="bg-gray-700 rounded-xl shadow-lg overflow-hidden p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {category.partners.map((partner, index) => (
                  <div
                    key={index}
                    className="bg-gray-800 rounded-lg p-6 transition-all duration-300 hover:shadow-cyan-400/10 hover:scale-105"
                  >
