    ...
    <section className="py-20 bg-gradient-to-b from-gray-800 to-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">Partner Testimonials</h2>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-gray-800 rounded-xl shadow-lg overflow-hidden p-6 transition-all duration-300 hover:shadow-cyan-400/20 hover:scale-105"
            >
              <div className="mb-4">
        ...
        <div className="mt-16 bg-gray-700 rounded-xl p-8 max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-20 h-20 bg-cyan-500/20 rounded-full flex items-center justify-center flex-shrink-0">
              <Quote className="h-10 w-10 text-cyan-400" />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-white mb-4">Impact Through Collaboration</h3>
