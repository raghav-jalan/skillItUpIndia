    ...
    <section className="py-20 bg-gray-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">Help Center</h2>
          ...
          <div className="mt-8 max-w-2xl mx-auto">
            <div className="relative">
              <input
                ...
                className="w-full px-5 py-3 bg-gray-700 border border-gray-600 rounded-full focus:outline-none focus:ring-2 focus:ring-cyan-500 text-white pr-12"
              />
              <button className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-cyan-400">
          ...
          {helpCategories.map((category, index) => (
            ...
            >
              <div className="p-6">
                ...
                <Link href="#" className="inline-block text-white hover:text-cyan-400 transition-colors font-medium">
                  View all articles →
                </Link>
              </div>
            </div>
